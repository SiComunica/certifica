      ...
      try {
        ...
        try {
          ...
          if (notificationsError) {
            console.error('Errore dettagliato notifiche:', notificationsError)
            throw notificationsError
          }

          console.log('Notifiche ricevute:', notificationsData)
          setNotifications(notificationsData || [])
        } catch (notificationError) {
          console.error('Errore catch notifiche:', notificationError)
          setNotifications([])
        ...
        if (practicesError) {
          console.error('Errore pratiche:', practicesError)
